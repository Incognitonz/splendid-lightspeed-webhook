...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    // Lab service Product IDs organized by turnaround type (from your CSV)
    ...
    // B&W film product IDs (products that contain "bw" in handle or are B&W specific)
    ...
    const allLabServiceProductIds = [...labServiceProductIds.fast, ...labServiceProductIds['3day'], ...labServiceProductIds['1week']];
